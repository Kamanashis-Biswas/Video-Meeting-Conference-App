...
public class SignUpActivity extends AppCompatActivity {
    ...
    private EditText inputFastName, inputLastName, inputEmail, inputPassword, inputConfirmPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputFastName = findViewById(R.id.inputFastName);
        ...
        buttonSignUp.setOnClickListener(view -> {
            if (inputFastName.getText().toString().trim().isEmpty()) {
    ...
    private void signUp(){
        ...
        user.put(Constants.KEY_FIRST_NAME, inputFastName.getText().toString());
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    preferenceManager.putString(Constants.KEY_FIRST_NAME, inputFastName.getText().toString());
